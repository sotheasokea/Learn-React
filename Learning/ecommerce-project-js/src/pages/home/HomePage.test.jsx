...
describe("HomePage Component", () => {
  ...
  it("displays the products correct", async () => {
    ...
    // we don't have to check this, cause we already test for the product
    expect(
  ...
  it("test add to cart button", async ()=> {
    render(
      <MemoryRouter>
        <HomePage cart={[]} loadCart={loadCart} />
      </MemoryRouter>
    ...
    expect(
      within(productContainer[0]).getByTestId('add-to-cart-button')
    ).toBeInTheDocument();
    ...
    await user.click(
      within(productContainer[1]).getByTestId('add-to-cart-button')
    );
